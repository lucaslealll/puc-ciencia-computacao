...
.text
	li $t1, 2		# t1 recebe imediatamente (sem necessidade de variavel extra) o valore de 10
	
	sll $s0, $t1, 10	# s0 recebe o valor de t1 multiplicado por 2 deslocado 10 casas para a esquerda...equivalente a 2^10
